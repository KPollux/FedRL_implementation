...
# Cartpole
log_paths = [
    'PPO_HalfCheetah_1step_SGD_INDL_0.0001_2023-08-20-23-00-48',
    'PPO_HalfCheetah_1step_SGD_ShareParameter_0.0001_2023-08-21-02-26-22',
    'PPO_HalfCheetah_1step_SGD_QAvg_2023-08-21-13-07-53',
    ...
    'PPO_HalfCheetah_1step_SGD_QGradual_147_decay_gap_1_2023-08-21-11-25-42',
...
for floder_name in log_paths:
    ...
    for idx in range(n_agents):
        idx = str(idx)
        temp_log_agent_rewards_list.append(train_history[idx]['agent_rewards'][:300000])
        # temp_log_agent_paths_length_list.append(train_history['agent_paths_length'])
        # temp_log_agent_wins_list.append(train_history['agent_wins'])
...
legends = ['PPO', 'PPOShare', 'PPOAvg', 'PPOGradual']

# # %%
# for lis in log_agent_rewards_list:
#     print(len(lis[0]))
# %%
import numpy as np
